...
class TestNameConventionAPTest implements UnitTest {
    ...
    void expectTransformation(Map<String, String> sources, @Language("XML") String expectedOutput) {
        ...
        cute.andUseCompilerOptions("-A" + TestNameConventionAP.indentXmlOption + "=true").whenCompiled()
            .thenExpectThat().compilationSucceeds()
            .andThat().fileObject(StandardLocation.SOURCE_OUTPUT, TestNameConventionAP.enforcementsXmlPackage, TestNameConventionAP.enforcementsXmlName).matches(contentMatcher(expectedOutput))
            .executeTest();
    }
